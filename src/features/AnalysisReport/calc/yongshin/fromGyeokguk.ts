...
import type { GyeokgukInner } from "@/features/AnalysisReport/logic/gyeokguk/types";
import type { Element } from "../../utils/types";
import type { YongshinItem } from "./multi";

const PRODUCES: Record<Element, Element> = { 목: "화", 화: "토", 토: "금", 금: "수", 수: "목" };
const PRODUCED_BY: Record<Element, Element> = { 목: "수", 화: "목", 토: "화", 금: "토", 수: "금" };
const CONTROLS: Record<Element, Element> = { 목: "토", 화: "금", 토: "수", 금: "목", 수: "화" };
const CONTROLLED_BY: Record<Element, Element> = { 목: "금", 화: "수", 토: "목", 금: "화", 수: "토" };
