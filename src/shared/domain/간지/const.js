...
export const is천간_양간 = (stem) => ['갑', '병', '무', '경', '임'].includes(stem);
export const is천간_음간 = (stem) => ['을', '정', '기', '신', '계'].includes(stem);
export const is지지_양간 = (branch) => ['자', '인', '진', '오', '신', '술'].includes(branch);
export const is지지_음간 = (branch) => ['축', '묘', '사', '미', '유', '해'].includes(branch);
export const 간지_MAP = {
