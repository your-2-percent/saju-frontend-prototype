  ...
  return (
    <div className="flex-1 rounded-md border border-neutral-200 dark:border-neutral-800 p-1 desk:p-2">
      ...
      {tags.length === 0 ? (
        ...
        <div className="flex flex-row desk:flex-col gap-1 desk:gap-2">
          {tags.map((tag) => {
            ...
            return (
              <button
                ...
                className={[
                  "px-1 desk:px-2 py-1 text-[10px] desk:text-[11px] rounded border transition desk:break-keep cursor-pointer",
                  isActive
