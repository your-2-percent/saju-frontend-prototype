...
import { useInputWizardModel } from "./inputApp/input/useInputWizardModel";
import type { GenderType, InputWizardProps, MingType } from "./inputApp/calc/inputWizardConfig";
