    ...
    >
      <div className="space-y-6">
        ...
        >
          ...
          <div className="space-y-4">
            <GuideShot
              ...
              caption={
                <BulletList>
                  <Bullet>칩을 클릭하면 설명이 나옵니다. 개념이 쉬운 편은 아니라서, 이해를 돕기 위해 추가해두었습니다.</Bullet>
                  <Bullet>첫 줄은 월령, 사령, 당령, 진신, 가신입니다.</Bullet>
                  <Bullet>두 번째 줄은 내격입니다.</Bullet>
                  <Bullet>세 번째 줄은 외격입니다.</Bullet>
                  <Bullet>마지막 줄은 물상 및 사주 특징에 대한 설명입니다.</Bullet>
                </BulletList>
              }
            />
        ...
        <GuideSection
          id="iching"
          title="10. 주역 · 육효 점 안내"
          description="명식을 선택한 뒤 질문을 확정하고, 카드 뽑기로 육효를 뽑아 해석을 진행하는 기능입니다."
        >
          <GuideShot
            src="/guide/36.PNG"
            title="주역 · 육효 점 하는 법 안내"
            caption={
              <BulletList>
                <Bullet>명식 리스트에서 먼저 명식을 골라주세요. 명식이 하나도 없으면 리스트 화면에 고를 명식이 나타나지 않으니, 저장 후 선택해 주시면 됩니다.</Bullet>
                <Bullet>연결된 명식 정보를 확인한 뒤, 점을 보고 싶은 질문을 작성해 주세요.</Bullet>
                <Bullet>상황을 구체적으로 적을수록 더 날카로운 답변을 얻기 쉽지만, 민감한 개인정보는 입력하지 않는 것을 권장드립니다.</Bullet>
                <Bullet>질문을 적고 질문 확정을 누르면 카드 뽑기 버튼이 활성화됩니다.</Bullet>
                <Bullet>한번에 뽑기는 육효가 한 번에 나오고, 한효씩 뽑기는 6번 눌러야 합니다. 취향에 맞는 방식을 선택해 주세요.</Bullet>
              </BulletList>
            }
          />

          <div className="flex flex-wrap gap-2">
            <GuideActionLink to="/iching">주역 · 육효 점 보러가기</GuideActionLink>
          </div>
        </GuideSection>

        <GuideSection
          id="finish"
          title="11. 더 도움이 필요할 때"
