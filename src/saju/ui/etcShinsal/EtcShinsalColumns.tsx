...
import {
  ...
  getShinsalTooltip,
} from "@/analysisReport/calc/logic/shinsal/shinsalTooltips";
  ...
  return (
    <div ref={wrapRef} className="relative">
      <button
        ...
        className={[
          "px-2 py-1 text-[12px] desk:text-[11px] text-center  rounded border desk:break-keep w-full cursor-pointer ",
          open
