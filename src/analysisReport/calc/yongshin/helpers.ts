import type { Element, TenGod, PowerData } from "@/analysisReport/calc/utils/types";
import { BRANCH_MAIN_ELEMENT, STEM_TO_ELEMENT } from "@/analysisReport/calc/core/common";
