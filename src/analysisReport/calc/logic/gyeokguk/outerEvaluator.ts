...
import { stemOf, branchOf, isYangStem, mapStemToTenGodSub, uniq } from "@/analysisReport/calc/logic/gyeokguk/utils";
import { mapBranchToTenGodSub, elementToTenGod } from "@/analysisReport/calc/logic/gyeokguk/utils";
import { TenGodSubtype } from "@/analysisReport/calc/logic/gyeokguk/types";
import {
  hiddenStemMappingClassic,
  hiddenStemMappingHGC
} from "@/shared/domain/hidden-stem/const";
import { firstChar, secondChar } from "@/analysisReport/calc/logic/gyeokguk/structureTags";
