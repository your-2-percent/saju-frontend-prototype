...
import { getDayGanZhi } from "@/shared/domain/ganji/common";
import { normalizeStem } from "@/shared/domain/ganji/normalize";
...
import { ensureSolarBirthDay } from "./ensureSolarBirthDay";

// ✅ barrel export ("@/myeongsik/calc"에서 re-export)
export { ensureSolarBirthDay };

export { reviveAndRecalc, computeDaewoonDir, normalizeGender } from "@/myeongsik/calc/derive";
export {
  buildMyeongSik,
...
export function toCorrected(ms: MyeongSik, dstOffsetMinutes = 0): Date {
  ...
  const isUnknownPlace =
    !solarized.birthPlace ||
    (typeof solarized.birthPlace === "object" && solarized.birthPlace.name === "모름");
